...
set :repository,  "git@github.com:agordillo/LOEP.git"
...
role :web, "loep.global.dit.upm.es"                          # Your HTTP server, Apache/etc
role :app, "loep.global.dit.upm.es"                          # This may be the same as your `Web` server
